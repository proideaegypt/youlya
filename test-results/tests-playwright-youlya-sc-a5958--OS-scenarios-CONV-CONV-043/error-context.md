...
- Name: tests/playwright-youlya-scenarios.spec.ts >> Youlya AI Commerce OS scenarios (CONV) >> CONV-043
- Location: tests/playwright-youlya-scenarios.spec.ts:77:9

# Error details

```
Error: CONV-043 reply should include one of: هحولك لفريق الدعم | فريق الدعم
