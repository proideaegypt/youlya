...
- Name: tests/playwright-youlya-scenarios.spec.ts >> Youlya AI Commerce OS scenarios (CONV) >> CONV-054
- Location: tests/playwright-youlya-scenarios.spec.ts:77:9

# Error details

```
Error: CONV-054 reply should include one of: تمام | ممكن توضحلي
